              ...
              <div key={item.id} className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                ...
                <div className="p-4">
                  <input
                    ...
                    className="w-full text-sm text-gray-600 font-medium px-2 py-1 mb-2 border-b border-blue-500 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
                    // className="text-sm  bg-transparent p-0 border-b border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 rounded px-1"
